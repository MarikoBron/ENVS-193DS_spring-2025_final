...
In 2016, the predicted probability of nest box occupancy by Swift Parrots is 48% at 0 m from the forest edge and 12% at 900 m from the forest edge based on ggpredict results. In 2019, predicted probability of occupancy is 30% at 0 m from the forest edge and 6% at 900 m from the forest edge. There is a negative relationship between distance from the forest edge and nest box occupancy by Swift Parrots in both years.
